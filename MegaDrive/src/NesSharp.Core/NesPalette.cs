...
/// <summary>Maps the 2C02's 64 system palette indices (what <see cref="Ppu2C02.Frame"/>
/// stores per pixel) to display RGB. There is no single "correct" NES palette — different
/// PPU revisions and generation methods (direct capture, NTSC decoding, etc.) all differ
/// slightly — this is a commonly used, visually accurate approximation.</summary>
